...
_lldb.LLDB_INVALID_COLUMN_NUMBER_swigconstant(_lldb)
...
_lldb.LLDB_OPT_SET_12_swigconstant(_lldb)
...
_lldb.eLaunchFlagInheritTCCFromParent_swigconstant(_lldb)
...
_lldb.eArgTypeFileLineColumn_swigconstant(_lldb)
...
_lldb.eArgTypeModuleUUID_swigconstant(_lldb)
...
_lldb.eCommandProcessMustBeTraced_swigconstant(_lldb)
...
class SBModule(_object):
    ...
    __swig_getmethods__["GarbageCollectAllocatedModules"] = lambda x: GarbageCollectAllocatedModules
